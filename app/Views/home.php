...
<section class="banner_section">
    <div class="container">
        <div class="row">
            ...
            <div class="col-xl-6 col-md-6 col-12">
                <img src="images/Shopping-Download-PNG-removebg-preview.png" class="banner_img" alt="">
            </div>
        </div>
    </div>
</section>
        ...
        <div class="slider2 owl-carousel owl-theme">
            ...
            <div class="item">
                <div class="products_imgbox">
                    <img src="images/product-24.jpg" class="products_img">
                    <h3>T-Shirt</h3>
                    <h4>black</h4>
                    <p>1 pc</p>
            ...
            <div class="item">
                <div class="products_imgbox">
                    <img src="images/product-26.jpg" class="products_img">
                    <h3>Sunglases</h3>
                    <h4>Yellow</h4>
                    <p>1pc</p>
                    <div class="products_textbox">
            ...
            <div class="item">
                <div class="products_imgbox">
                    <img src="images/product-1.jpg" class="products_img">
                    <h3>Dress</h3>
                    <h4>Pink</h4>
                    <p>1pc</p>
                    <div class="products_textbox">
            ...
            <div class="item">
                <div class="products_imgbox">
                    <img src="images/product-21.jpg" class="products_img">
                    <h3>T-Shirt</h3>
                    <h4>Green</h4>
                    <p>1pc</p>
                    <div class="products_textbox">
            ...
            <div class="item">
                <div class="products_imgbox">
                    <img src="images/product-4.jpg" class="products_img">
                    <h3>Dress</h3>
                    <h4>White</h4>
                    <p>1pc</p>
                    <div class="products_textbox">
